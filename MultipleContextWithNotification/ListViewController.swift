...
class ListViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.privateContext?.persistentStoreCoordinator = self.coreDataStack.managedContext.persistentStoreCoordinator
        
        
        let notificationCenter = NotificationCenter.default
        notificationCenter.addObserver(self, selector: #selector(managedObjectContextDidSave(_:)), name: NSNotification.Name.NSManagedObjectContextDidSave, object: self.privateContext)
...
extension ListViewController:EditViewControllerDelegate{
    ...
    func doneEditing(_ save:Bool){
        guard let context = self.privateContext else{
            print("Unable to get private context")
            return
        }
        guard save,
